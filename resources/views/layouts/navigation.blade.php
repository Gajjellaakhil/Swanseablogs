<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('articles') }}">
                        <img src="{{url('images/logo-blue.jpg')}}" alt="logo" class="h-16">
                    </a>
                </div>
                ...
                @if (Auth::user()->role !== 'admin')
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('article.myArticles')" :active="request()->routeIs('article.myArticles')">
                            {{ __('My Articles') }}
                        </x-nav-link>
                    </div>
                @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (Auth::user()->role !== 'admin')
                <x-responsive-nav-link :href="route('article.myArticles')" :active="request()->routeIs('article.myArticles')">
                    {{ __('My Articles') }}
                </x-responsive-nav-link>
            @endif
